        ...
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <p class="card-text mb-4"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              ...
              <a href="course-single.php" class="btn btn-primary btn-sm">Read more</a>
          </div>
        </div>
      </div>
      <!-- course item -->
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <a href="course-single.php">
              <h4 class="card-title">Kiswahili</h4>
            </a>
            <p class="card-text mb-4"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna.</p>
              <a href="course-single.php" class="btn btn-primary btn-sm">Read more</a>
        ...
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              ...
              <li class="list-inline-item">
                <a class="text-color" href="#">Humanities</a>
              </li>
            </ul>
            <a href="course-single.php">
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <a href="course-single.php">
              <h4 class="card-title">Social Studies</h4>
            </a>
            <p class="card-text mb-4"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna.</p>
              <a href="course-single.php" class="btn btn-primary btn-sm">Read more</a>
        ...
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              ...
              <li class="list-inline-item">
                <a class="text-color" href="#">Cocurriculum Activities</a>
              </li>
            </ul>
            <a href="course-single.php">
              <h4 class="card-title">Games & Sports</h4>
            </a>
            <p class="card-text mb-4"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna.</p>
              <a href="course-single.php" class="btn btn-primary btn-sm">Read more</a>
