          ...
          <div class="col-xl-8 col-lg-7">
            <div class="row feature-blocks bg-gray justify-content-between">
              <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
                ...
                <h3 class="mb-xl-4 mb-lg-3 mb-4">Goshen News</h3>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 order-2 order-md-1">
            <h2 class="section-title">About Goshen</h2>
        ...
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              ...
              <li class="list-inline-item">
                <a class="text-color" href="#">Sciences</a>
              </li>
            </ul>
            <a href="course-single.php">
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <p class="card-text mb-4"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna.</p>
              <a href="course-single.php" class="btn btn-primary btn-sm">Read more</a>usus
          </div>
        </div>
      </div>
