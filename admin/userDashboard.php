  ...
  <body>    
    ...
    <div class="container">
        ...
        <div class="col-md-8">
            ...
            <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">User Dashboard</a></li>
                  ...
                  <div class="col-sm-3">
                    <div class="card card-sm border-primary rounded-1 hover-shadow">
                      <div class="card-body">
                        ...
                        <p class="text-center pt-0">PUPILS</p>
                      </div>
